...
public class ChatUtils {
    ...
    //sets the state and informs the handler
    ...
    //when clicked on an available device
    //connects your device to the other device
    ...
    //listens on the provided UUID and APP Name
    /*it returns a connected bluetooth socket when
